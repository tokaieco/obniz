...
// ★★★ このゲートウェイのID ★★★
const THIS_GATEWAY_OBNIZ_ID = '7873-1040'; // Gateway1

// (これ以降のコードは gateway_app.js と同じだが、obniz.display.* が全て削除されている)
...
obniz.onconnect = async function () {
  console.log(`[${THIS_GATEWAY_CONFIG.name}] Online. Scan starting...`);
  await obniz.ble.initWait();
  console.log(`[${THIS_GATEWAY_CONFIG.name}] BLE ready.`);
